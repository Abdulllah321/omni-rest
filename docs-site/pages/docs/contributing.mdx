...
- **TypeScript**: Use TypeScript for all code (no `any` unless necessary)
...
1. **Update Documentation** - Changes in `docs/` and README.md
2. **Add Tests** - New features must have tests
3. **Update Changelog** - Add entry to CHANGELOG.md
4. **Build & Test** - `npm run build && npm test` must pass
